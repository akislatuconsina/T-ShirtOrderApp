...
export class OzanorderproductApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public lookingdetailorderproduct(params: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Ozanorderproducts/lookingdetailorderproduct";
    let _routeParams: any = {};
    let _postBody: any = {
      params: params
    };
   ...
   * </em>
   */
  public changedetailproduct(params: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Ozanorderproducts/changedetailproduct";
    let _routeParams: any = {};
    let _postBody: any = {
      params: params
    };
   ...
   * </em>
   */
  public updatedetailproduct(params: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Ozanorderproducts/updatedetailproduct";
    let _routeParams: any = {};
    let _postBody: any = {
      params: params
    };
