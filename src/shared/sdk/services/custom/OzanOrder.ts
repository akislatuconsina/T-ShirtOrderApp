...
/**
 * Api services for the `Ozanorder` model.
 */
@Injectable()
export class OzanorderApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public manageorder(params: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Ozanorders/manageorder";
    let _routeParams: any = {};
    let _postBody: any = {
      params: params
    };
   ...
   * </em>
   */
  public download(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Ozanorders/:id/download";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getreportDP(params: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Ozanorders/getreportDP";
    let _routeParams: any = {};
    let _postBody: any = {
      params: params
    };
   ...
   * </em>
   */
  public getreportFP(params: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Ozanorders/getreportFP";
    let _routeParams: any = {};
    let _postBody: any = {
      params: params
    };
