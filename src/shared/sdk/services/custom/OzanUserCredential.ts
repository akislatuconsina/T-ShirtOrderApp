...
export class OzanUserCredentialApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public ozanLogout(params: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/OzanUserCredentials/ozanLogout";
    let _routeParams: any = {};
    let _postBody: any = {
      params: params
    };
   ...
   * </em>
   */
  public ozanRegistration(params: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/OzanUserCredentials/ozanRegistration";
    let _routeParams: any = {};
    let _postBody: any = {
      params: params
    };
